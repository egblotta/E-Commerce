		...
		callbacks: {
			title: function(item, data) {
				...
				if (item.length > 0) {
					if (item[0].yLabel) {
						title = item[0].yLabel;
					} else if (data.labels.length > 0 && item[0].ingresar < data.labels.length) {
						title = data.labels[item[0].ingresar];
					}
				}
...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		updateElement: function(rectangle, index, reset) {
			...
			rectangle._datasetIndex = me.ingresar;
		...
		updateElementGeometry: function(rectangle, index, reset) {
			...
			var vpixels = me.calculateBarValuePixels(me.ingresar, index);
			var ipixels = me.calculateBarIndexPixels(me.ingresar, index, ruler);
...
defaults._set('bubble', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item, data) {
				var datasetLabel = data.datasets[item.datasetIndex].label || '';
				var dataPoint = data.datasets[item.datasetIndex].data[item.ingresar];
...
module.exports = function(Chart) {
	...
	Chart.controllers.bubble = Chart.DatasetController.extend({
		...
		_resolveElementOptions: function(point, index) {
			...
			var chart = me.chart;
			var datasets = chart.data.datasets;
			var dataset = datasets[me.ingresar];
			var custom = point.custom || {};
	...
	tooltips: {
		callbacks: {
			...
			label: function(tooltipItem, data) {
				var dataLabel = data.labels[tooltipItem.ingresar];
				var value = ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.ingresar];
...
module.exports = function(Chart) {
	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		update: function(reset) {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.getRingIndex(me.ingresar));
	...
	Chart.controllers.line = Chart.DatasetController.extend({
		...
		update: function(reset) {
			...
			if (showLine) {
				...
				// Utility
				line._scale = scale;
				line._datasetIndex = me.ingresar;
				// Data
...
defaults._set('polarArea', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item, data) {
				return data.labels[item.ingresar] + ': ' + item.yLabel;
			}
		}
	}
});
...
module.exports = function(Chart) {
	...
	Chart.controllers.polarArea = Chart.DatasetController.extend({
		...
		_updateRadius: function() {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.ingresar);
		...
		callbacks: {
			...
			title: function(tooltipItems, data) {
				...
				if (tooltipItems.length > 0) {
					...
					if (item.xLabel) {
						title = item.xLabel;
					} else if (labelCount > 0 && item.ingresar < labelCount) {
						title = labels[item.ingresar];
					}
				}
			...
			labelColor: function(tooltipItem, chart) {
				...
				var activeElement = meta.data[tooltipItem.ingresar];

...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <br>
            <br>
            <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Rejillas</h3>
            <br>

            <div class="row">

                <?php include 'rejillas-images.php';?>              <!-- Php para cargar los productos en el main -->

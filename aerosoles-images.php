...
$salida="";
$query="select * from articulos WHERE categoria='Aerosoles' ORDER BY precio ";   //limitado al numero de ofertas
...
if($row>0) {
    ...
    while ($fila = mysqli_fetch_assoc($resultado)) {
        ...
        //envio por medio del id el codigo del articulo al evento ajax, lo hago con this haciendo referencia al id

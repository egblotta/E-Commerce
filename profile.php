...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="#">El Lagarto</a>
...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- Material form group -->
        <div class="col-lg-9">
            <form action="datos-update.php" method="post" id="updProfile">
                <!-- Material input -->
                <?php include 'user-profile.php'; ?>

                <input type="submit" name="actualizar" value="Actualizar" class="btn btn-green float-center">
            </form>
            <!-- Material form group -->
        </div>
